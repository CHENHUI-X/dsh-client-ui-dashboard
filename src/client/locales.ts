...
export const zh = {
  ...
  "hint.decodeSpeed": "解码吞吐 = 解码 tokens ÷ 解码耗时(全量)。",
  ...
  "hint.cost": "按 DeepSeek 公开定价(2025-09 生效,每 1M tokens:chat 未命中 $0.27 / 命中 $0.07 / 输出 $1.10;reasoner 翻倍)粗估的美元成本;缓存写入按未命中价;缓存节省 = 命中 tokens × (未命中价 − 命中价)。",
...
export const en: Record<keyof typeof zh, string> = {
  ...
  "hint.decodeSpeed": "Decode throughput = decode tokens ÷ decode time (all-time).",
  ...
  "hint.cost": "Rough USD cost at DeepSeek public pricing (effective 2025-09; per 1M tokens: chat miss $0.27 / hit $0.07 / output $1.10; reasoner doubles it). Cache writes billed at the miss rate; savings = cache-read tokens × (miss − hit).",
