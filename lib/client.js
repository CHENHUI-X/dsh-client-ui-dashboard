window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "hud.goal": "\u76EE\u6807",
		  "hud.todos": "\u4EFB\u52A1",
		  "hud.todos.value": "{n} \u4E2A\u8FDB\u884C\u4E2D",
		  "hud.subagents": "\u5B50\u4EE3\u7406",
		  "hud.subagents.value": "{n} \u4E2A\u8FD0\u884C\u4E2D",
		  "hud.workflow": "\u5DE5\u4F5C\u6D41",
		  "hud.workflow.value": "{n} \u4E2A\u8FD0\u884C\u4E2D",
		  "hud.schedule": "\u63D0\u9192",
		  "board.col.inProgress": "\u8FDB\u884C\u4E2D",
		  "board.col.planned": "\u8BA1\u5212",
		  "board.col.blocked": "\u963B\u585E",
		  "board.col.done": "\u5DF2\u5B8C\u6210",
		  "board.goal.phase.active": "\u8FDB\u884C\u4E2D",
		  "board.goal.phase.paused": "\u5DF2\u6682\u505C",
		  "board.goal.phase.complete": "\u5DF2\u5B8C\u6210",
		  "board.goal.phase.blocked": "\u5DF2\u963B\u585E",
		  "board.goal.phase.cleared": "\u5DF2\u6E05\u9664",
		  "board.goal.rounds": "\u7B2C {n}/{m} \u8F6E",
		  "board.goal.blockedReason": "\u539F\u56E0: {message}",
		  "board.todo.status.pending": "\u5F85\u529E",
		  "board.todo.status.inProgress": "\u8FDB\u884C\u4E2D",
		  "board.todo.status.completed": "\u5DF2\u5B8C\u6210",
		  "board.workflow.running": "\u8FD0\u884C\u4E2D",
		  "board.workflow.members": "{n} \u4E2A\u6210\u5458",
		  "board.workflow.member.outcome.running": "\u8FD0\u884C\u4E2D",
		  "board.workflow.member.outcome.completed": "\u5B8C\u6210",
		  "board.workflow.member.outcome.failed": "\u5931\u8D25",
		  "board.workflow.member.outcome.cancelled": "\u5DF2\u53D6\u6D88",
		  "board.workflow.stop.completed": "\u5DF2\u5B8C\u6210",
		  "board.workflow.stop.cancelled": "\u5DF2\u53D6\u6D88",
		  "board.workflow.stop.error": "\u51FA\u9519",
		  "board.subagents.running": "\u8FD0\u884C\u4E2D",
		  "board.subagents.inactive": "\u7A7A\u95F2",
		  "board.subagent.mode.oneShot": "\u4E00\u6B21\u6027",
		  "board.subagent.mode.continuable": "\u53EF\u7EE7\u7EED",
		  "board.schedule.overdue": "\u5DF2\u5230\u671F",
		  "board.schedule.dispatched": "\u5DF2\u89E6\u53D1",
		  "board.schedule.due": "\u4E8E {time}",
		  "board.schedule.every": "\u6BCF {s}s",
		  "board.empty": "\u4F1A\u8BDD\u8FD8\u6CA1\u6709\u6D3B\u52A8 \u2014\u2014 \u53D1\u8D77\u76EE\u6807\u3001\u4EFB\u52A1\u3001\u5DE5\u4F5C\u6D41\u6216\u63D0\u9192\u540E,\u5B83\u4EEC\u4F1A\u81EA\u52A8\u51FA\u73B0\u5728\u8FD9\u91CC\u3002",
		  "board.hint": "\u770B\u677F\u7531\u4F1A\u8BDD\u65E5\u5FD7\u81EA\u52A8\u9A71\u52A8:goal / todo / workflow / schedule / subagent \u4E8B\u4EF6\u81EA\u52A8\u4E0A\u677F,\u65E0\u9700\u624B\u52A8\u7EF4\u62A4\u3002"
		};
		var en = {
		  ...
		  "board.section": "Activity board",
		  "hud.status": "Status",
		  "hud.status.running": "Running",
		  "hud.status.idle": "Idle",
		  "hud.tool": "Tool",
		  "hud.goal": "Goal",
		  "hud.todos": "Todos",
		  "hud.todos.value": "{n} in progress",
		  "hud.subagents": "Subagents",
		  "hud.subagents.value": "{n} running",
		  "hud.workflow": "Workflow",
		  "hud.workflow.value": "{n} running",
		  "hud.schedule": "Reminder",
		  "board.col.inProgress": "In progress",
		  "board.col.planned": "Planned",
		  "board.col.blocked": "Blocked",
		  "board.col.done": "Done",
		  "board.goal.phase.active": "Active",
		  "board.goal.phase.paused": "Paused",
		  "board.goal.phase.complete": "Completed",
		  "board.goal.phase.blocked": "Blocked",
		  "board.goal.phase.cleared": "Cleared",
		  "board.goal.rounds": "round {n}/{m}",
		  "board.goal.blockedReason": "Reason: {message}",
		  "board.todo.status.pending": "Pending",
		  "board.todo.status.inProgress": "In progress",
		  "board.todo.status.completed": "Completed",
		  "board.workflow.running": "Running",
		  "board.workflow.members": "{n} members",
		  "board.workflow.member.outcome.running": "running",
		  "board.workflow.member.outcome.completed": "completed",
		  "board.workflow.member.outcome.failed": "failed",
		  "board.workflow.member.outcome.cancelled": "cancelled",
		  "board.workflow.stop.completed": "Completed",
		  "board.workflow.stop.cancelled": "Cancelled",
		  "board.workflow.stop.error": "Failed",
		  "board.subagents.running": "Running",
		  "board.subagents.inactive": "Idle",
		  "board.subagent.mode.oneShot": "one-shot",
		  "board.subagent.mode.continuable": "continuable",
		  "board.schedule.overdue": "Overdue",
		  "board.schedule.dispatched": "Dispatched",
		  "board.schedule.due": "at {time}",
		  "board.schedule.every": "every {s}s",
		  "board.empty": "No session activity yet \u2014 start a goal, todos, workflow or reminder and it will appear here automatically.",
		  "board.hint": "The board is driven by the session log: goal / todo / workflow / schedule / subagent events land here automatically, no manual card management."
		};
		...
		function scheduledItems(board, nowMs) {
		  return board.schedule.filter((i) => i.state === "scheduled").sort((a, b) => Date.parse(a.scheduledAt) - Date.parse(b.scheduledAt));
		}
		function nextSchedule(board, nowMs) {
		  return scheduledItems(board, nowMs)[0] ?? null;
		}
		function runningRuns(board) {
		  return board.workflow.filter((r) => r.running);
		}
		function doneRuns(board) {
		  return board.workflow.filter((r) => !r.running);
		}
		function erroredRuns(board) {
		...
		function goalShortLabel(t, goal) {
		  ...
		  return `${clipped} \xB7 ${rounds}`;
		}
		function scheduleDueLabel(item) {
		  const at = Date.parse(item.scheduledAt);
		...
		function elapsedLabel(time, nowMs) {
		  const s = Math.max(0, Math.round((nowMs - time) / 1e3));
		  return s < 60 ? `${s}s` : `${Math.floor(s / 60)}m${s % 60 > 0 ? `${s % 60}s` : ""}`;
		}
		function Chip(props) {
		  const { tone, label, value } = props;
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dshd-hud-chip", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `dshd-hud-dot dshd-dot-${tone}`, "aria-hidden": "true" }),
		    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dshd-hud-label", children: label }),
		    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dshd-hud-value", children: value })
		  ] });
		}
		function HudStrip(props) {
		  ...
		  const goalTone = goal === null ? "idle" : goal.goal.phase === "blocked" ? "bad" : goal.goal.phase === "active" ? "accent" : "idle";
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dshd-hud", role: "status", "aria-live": "polite", children: [
		    ...
		    data.currentTool !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        tone: "accent",
		        label: t("hud.tool"),
		        value: `${data.currentTool.name} \xB7 ${elapsedLabel(data.currentTool.time, nowMs)}`
		      }
		    ),
		    goal !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, { tone: goalTone, label: t("hud.goal"), value: goalShortLabel(t, goal) }),
		    data.inProgressTodos > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        tone: "good",
		        label: t("hud.todos"),
		    ...
		    data.runningSubagents > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        tone: "good",
		    ...
		    data.runningWorkflow > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        tone: "good",
		    ...
		    data.nextSchedule !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        tone: "warn",
		        label: t("hud.schedule"),
		        value: scheduleDueLabel(data.nextSchedule)
		      }
		    )
		  ] });
		}

		// src/client/BoardView.tsx
		var import_react2 = require("react");
		var import_jsx_runtime2 = require("react/jsx-runtime");
		function Card(props) {
		  const { tone, title, meta, children } = props;
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: `dshd-bcard${tone === void 0 ? "" : ` dshd-bcard-${tone}`}`, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-bcard-head", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-bcard-title", children: title }),
		      meta !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-bcard-meta", children: meta })
		    ] }),
		    children !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-bcard-body", children })
		  ] });
		}
		function GoalCard(props) {
		  const { goal, t } = props;
		  const g = goal.goal;
		  const tone = g.phase === "blocked" ? "bad" : g.phase === "active" ? "accent" : "idle";
		  const rounds = t("board.goal.rounds").replace("{n}", String(goal.roundsStarted)).replace("{m}", String(g.maxGoalRounds));
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone, title: g.objective, meta: `${goalPhaseLabel(t, g.phase)} \xB7 ${rounds}`, children: g.phase === "blocked" && g.blockedReason !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-bcard-note", children: t("board.goal.blockedReason").replace("{message}", g.blockedReason.message) }) });
		}
		function TodoCard(props) {
		  const { item, t } = props;
		  const tone = item.status === "in_progress" ? "accent" : item.status === "completed" ? "good" : "idle";
		  const status = item.status === "in_progress" ? t("board.todo.status.inProgress") : item.status === "completed" ? t("board.todo.status.completed") : t("board.todo.status.pending");
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone, title: item.content, meta: status });
		}
		var MEMBER_OUTCOME_KEY = {
		  running: "board.workflow.member.outcome.running",
		  completed: "board.workflow.member.outcome.completed",
		  failed: "board.workflow.member.outcome.failed",
		  cancelled: "board.workflow.member.outcome.cancelled"
		};
		function WorkflowRunCard(props) {
		  const { run, t } = props;
		  const tone = run.running ? "accent" : run.stopReason === "error" ? "bad" : run.stopReason === "cancelled" ? "warn" : "good";
		  const meta = run.running ? `${t("board.workflow.members").replace("{n}", String(run.members.length))} \xB7 ${t("board.workflow.running")}` : t(`board.workflow.stop.${run.stopReason ?? "completed"}`);
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone, title: run.name, meta, children: run.members.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: "dshd-member-list", children: run.members.map((m) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("li", { className: "dshd-member-row", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `dshd-dot dshd-dot-${m.outcome === "running" ? "accent" : m.outcome === "completed" ? "good" : m.outcome === "failed" ? "bad" : "warn"}`, "aria-hidden": "true" }),
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-member-label", children: m.label }),
		    m.phase !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-member-phase", children: m.phase }),
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-member-outcome", children: t(MEMBER_OUTCOME_KEY[m.outcome] ?? "board.workflow.member.outcome.completed") })
		  ] }, `${run.runId}:${m.seq}`)) }) });
		}
		function SubagentCard(props) {
		  const { entry, title, t } = props;
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone: running ? "accent" : "idle", title: label, meta: mode, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "dshd-bcard-note", children: [
		    running ? t("board.subagents.running") : t("board.subagents.inactive"),
		    title !== void 0 && title.length > 0 ? ` \xB7 ${title}` : ""
		  ] }) });
		}
		function ReminderCard(props) {
		  const { item, overdue, t } = props;
		  const tone = overdue ? "warn" : item.state === "dispatched" ? "good" : "idle";
		  const kind = item.kind === "every" ? t("board.schedule.every").replace("{s}", String(item.everySeconds ?? 0)) : scheduleDueLabel(item);
		  const state = item.state === "dispatched" ? t("board.schedule.dispatched") : overdue ? t("board.schedule.overdue") : t("board.schedule.due").replace("{time}", scheduleDueLabel(item));
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone, title: item.prompt, meta: `${kind} \xB7 ${state}` });
		}
		function BoardBody(props) {
		  const { useSession, useProjection, useSessions, t, sessionId } = props;
		  ...
		  void clock;
		  const boardValue = board ?? EMPTY_BOARD;
		  const todoList = todos ?? [];
		  const entries = catalogs[sessionId];
		  const subagents = childEntries(entries?.entries);
		  const nowMs = Date.now();
		  const activeGoal = goal != null && goal.goal.phase === "active" ? goal : null;
		  const blockedGoal = goal != null && goal.goal.phase === "blocked" ? goal : null;
		  const doneGoal = goal != null && goal.goal.phase === "complete" ? goal : null;
		  const pausedGoal = goal != null && goal.goal.phase === "paused" ? goal : null;
		  const reminders = scheduledItems(boardValue, nowMs);
		  const overdue = reminders.filter((r) => isOverdue(r, nowMs));
		  const upcoming = reminders.filter((r) => !isOverdue(r, nowMs));
		  const dispatched = boardValue.schedule.filter((r) => r.state === "dispatched");
		  const runningSubs = subagents.filter((e) => e.activity === "running");
		  const idleSubs = subagents.filter((e) => e.activity !== "running");
		  const doneWorkflow = doneRuns(boardValue).filter((r) => r.stopReason !== "error");
		  const failedWorkflow = erroredRuns(boardValue);
		  const runningWorkflow = runningRuns(boardValue);
		  const inProgress = inProgressTodos(todoList);
		  const pending = pendingTodos(todoList);
		  const completed = completedTodos(todoList);
		  const isEmpty = goal == null && todoList.length === 0 && boardValue.workflow.length === 0 && boardValue.schedule.length === 0 && subagents.length === 0 && runningCalls.length === 0;
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "dshd-boardTitle", children: t("board.section") }),
		    isEmpty ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-empty", children: t("board.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-board", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-col", "aria-label": t("board.col.inProgress"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h3", { className: "dshd-col-title", children: [
		          t("board.col.inProgress"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-col-count", children: [
		            activeGoal ? 1 : 0,
		            inProgress.length,
		            runningWorkflow.length,
		            runningSubs.length,
		            runningCalls.length,
		            overdue.length
		          ].reduce((a, b) => a + b, 0) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-col-body", children: [
		          activeGoal !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GoalCard, { goal: activeGoal, t }),
		          runningCalls.map((c) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Card, { tone: "accent", title: c.name, meta: t("hud.tool") }, c.callId)),
		          inProgress.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TodoCard, { item, t }, item.content)),
		          runningWorkflow.map((run) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WorkflowRunCard, { run, t }, run.runId)),
		          runningSubs.map((e) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SubagentCard, { entry: e, title: summaryTitle(summaries, e.id), t }, e.id)),
		          overdue.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ReminderCard, { item, overdue: true, t }, item.id))
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-col", "aria-label": t("board.col.planned"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h3", { className: "dshd-col-title", children: [
		          t("board.col.planned"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-col-count", children: [pausedGoal ? 1 : 0, pending.length, upcoming.length, idleSubs.length].reduce((a, b) => a + b, 0) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-col-body", children: [
		          pausedGoal !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GoalCard, { goal: pausedGoal, t }),
		          pending.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TodoCard, { item, t }, item.content)),
		          upcoming.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ReminderCard, { item, overdue: false, t }, item.id)),
		          idleSubs.map((e) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SubagentCard, { entry: e, title: summaryTitle(summaries, e.id), t }, e.id))
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-col", "aria-label": t("board.col.blocked"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h3", { className: "dshd-col-title", children: [
		          t("board.col.blocked"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-col-count", children: blockedGoal !== null ? 1 + failedWorkflow.length : failedWorkflow.length })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-col-body", children: [
		          blockedGoal !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GoalCard, { goal: blockedGoal, t }),
		          failedWorkflow.map((run) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WorkflowRunCard, { run, t }, run.runId))
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-col", "aria-label": t("board.col.done"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("h3", { className: "dshd-col-title", children: [
		          t("board.col.done"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-col-count", children: [doneGoal ? 1 : 0, completed.length, doneWorkflow.length, dispatched.length].reduce((a, b) => a + b, 0) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-col-body", children: [
		          doneGoal !== null && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(GoalCard, { goal: doneGoal, t }),
		          completed.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(TodoCard, { item, t }, item.content)),
		          doneWorkflow.map((run) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WorkflowRunCard, { run, t }, run.runId)),
		          dispatched.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ReminderCard, { item, overdue: false, t }, item.id))
		        ] })
		      ] })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-board-hint", children: t("board.hint") })
		  ] });
		}
		function summaryTitle(summaries, childId) {
		  const s = summaries[childId];
		  return typeof s === "object" && s !== null && typeof s.title === "string" ? s.title : void 0;
		}
		...
		function DonutChart(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { viewBox: `0 0 ${size} ${size}`, width: size, height: size, role: "img", "aria-label": ariaLabel ?? "donut chart", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("g", { transform: `rotate(-90 ${cx} ${cy})`, children: segments.map((seg, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		      "circle",
		      {
		        cx,
		        cy,
		        ...
		        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("title", { children: `${seg.label}: ${fmt(seg.value)}` })
		      },
		      i
		    )) }),
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx, cy, r: r - thickness / 2 - 3, fill: "var(--dsw-alias-bg-layer-1)" }),
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("text", { x: cx, y: cy + 14, textAnchor: "middle", dominantBaseline: "central", fontSize: 10, fill: "var(--dsw-alias-label-tertiary)", children: hovered === void 0 ? centerLabel : hovered.label })
		  ] });
		}
		function Legend(props) {
		  ...
		  const total = data.reduce((sum, d) => sum + Math.max(0, d.value), 0);
		  const fmt = valueFormatter ?? ((v) => compactNumber(v));
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-legend", children: data.map((d) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-legendRow", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendSwatch", style: { background: d.color } }),
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendName", children: d.label }),
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendValue", children: fmt(d.value) }),
		    percent ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-legendPercent", children: [
		...
		function StackedBar(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-chartBody", "data-stacked": true, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-stack", style: height === void 0 ? void 0 : { height }, children: segments.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-stackEmpty", children: emptyLabel ?? "\u2014" }) : segments.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		      "div",
		      {
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-stackLegend", children: [
		      data.filter((d) => d.value > 0).map((d) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-legendRow", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendSwatch", style: { background: d.color } }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendName", children: d.label }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendValue", children: fmt(d.value) })
		      ] }, d.label)),
		      totalLabel !== void 0 && segments.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-legendRow dshd-stackTotal", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendName", children: totalLabel }),
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-legendValue", children: fmt(total) })
		      ] }) : null
		    ] })
		  ] });
		}
		function SeriesBars(props) {
		  ...
		  const fmt = valueFormatter ?? ((v) => compactNumber(v));
		  if (series.length === 0) {
		    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-empty", style: { height, display: "flex", alignItems: "center", justifyContent: "center" }, children: emptyLabel ?? "\u2014" });
		  }
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-vbars", style: { height, position: "relative" }, role: "img", "aria-label": ariaLabel ?? "bar chart", children: [
		    showMaxTag ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-maxTag", children: fmt(max) }) : null,
		    series.map((s, i) => {
		        ...
		        "div",
		        {
		          ...
		          children: [
		            hover === i ? (() => {
		              ...
		              return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-vtip", style, children: [
		                s.label,
		                ": ",
		                fmt(v)
		              ] });
		            })() : null,
		            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-vbarTrack", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		              "div",
		              {
		                className: "dshd-vbar",
		...
		function HorizontalBars(props) {
		  ...
		  const fmt = valueFormatter ?? ((v) => compactNumber(v));
		  if (data.length === 0) {
		    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-empty", style: { padding: "12px" }, children: "\u2014" });
		  }
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-hbars", children: data.map((d) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-hbar", title: d.title ?? `${d.label}: ${fmt(d.value)}`, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-hbarName", children: d.label }),
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-hbarTrack", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		      "span",
		      {
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-hbarRight", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-hbarValue", children: [
		        fmt(d.value),
		        d.errorMark === true ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-errorMark", children: " \u26A0" }) : null
		      ] }),
		      d.sub !== void 0 && !subBelow ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-hbarSub", title: d.sub, children: d.sub }) : null
		    ] }),
		    d.sub !== void 0 && subBelow ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "dshd-hbarSubLine", title: d.sub, children: d.sub }) : null
		  ] }, d.label)) });
		}
		function AreaChart(props) {
		  ...
		  const gid = (0, import_react3.useId)();
		  const fmt = valueFormatter ?? ((v) => compactNumber(v));
		  if (n === 0) {
		    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-empty", style: { height, display: "flex", alignItems: "center", justifyContent: "center" }, children: emptyLabel ?? "\u2014" });
		  }
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
		    "div",
		    {
		      ...
		      children: [
		        showMaxTag ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-maxTag", children: fmt(max) }) : null,
		        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, preserveAspectRatio: "none", role: "img", "aria-label": ariaLabel ?? "area chart", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("linearGradient", { id: gid, x1: "0", y1: "0", x2: "0", y2: "1", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "0%", stopColor: color, stopOpacity: "0.25" }),
		            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("stop", { offset: "100%", stopColor: color, stopOpacity: "0.02" })
		          ] }) }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: areaPath, fill: `url(#${gid})`, vectorEffect: "non-scaling-stroke" }),
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: linePath, fill: "none", stroke: color, strokeWidth: 1.6, vectorEffect: "non-scaling-stroke" })
		        ] }),
		        hover !== null && pts[hover] !== void 0 && series[hover] !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
		          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		            "div",
		            {
		...
		function RadialGauge(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { viewBox: `0 0 ${size} ${height}`, width: size, height, role: "img", "aria-label": ariaLabel ?? "gauge", style: { overflow: "hidden" }, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: track, fill: "none", stroke: "var(--dsw-alias-border-l1)", strokeWidth: 11, strokeLinecap: "round" }),
		    frac > 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: valueArc, fill: "none", stroke: color, strokeWidth: 11, strokeLinecap: "round", style: { transition: "stroke .3s ease" } }) : null,
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("text", { x: cx, y: valueY, textAnchor: "middle", dominantBaseline: "central", fontSize: 21, fontWeight: 700, fill: "var(--dsw-alias-label-primary)", children: [
		      Math.round(frac * 100),
		      unit
		    ] })
		  ] });
		...
		function Sparkline({
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { width, height, viewBox: `0 0 ${width} ${height}`, className: "dshd-spark", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		    "polyline",
		    {
		      points: pts.join(" "),
		      fill: "none",
		...
		function ModelTimeline({
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dshd-modelTimeline", role: "img", "aria-label": ariaLabel ?? "model timeline", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, style: { display: "block" }, children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: 2, y1: height / 2, x2: width - 2, y2: height / 2, stroke: "var(--dsw-alias-border-l2)", strokeWidth: 1 }),
		      trimmed.map((d, i) => {
		        ...
		        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
		          "circle",
		          {
		            ...
		            children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("title", { children: `#${d.seq} \xB7 ${d.model}` })
		          },
		          d.seq
		        );
		      })
		    ] }),
		    note !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-modelNote", children: note }) : null,
		    axisHint !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-axisHint", children: axisHint }) : null,
		    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dshd-modelLegend", children: models.map((m) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dshd-modelLegendItem", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("i", { style: { background: modelColor(m) } }),
		      m
		    ] }, m)) })
		  ] });
		}
		...
		function Hint(props) {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives.Tooltip, { label: props.label, side: "top", delayMs: 450, maxWidth: 260, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-hint", role: "button", tabIndex: 0, "aria-label": props.label, children: "?" }) });
		}
		function fmtCost(v) {
		  if (v <= 0) return "$0";
		...
		function ChevronIcon(props) {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		    "svg",
		    {
		      ...
		      "aria-hidden": "true",
		      focusable: "false",
		      children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M5.5 3l5 5-5 5", fill: "none", stroke: "currentColor", strokeWidth: "1.9", strokeLinecap: "round", strokeLinejoin: "round" })
		    }
		  );
		}
		function WarnIcon() {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("svg", { className: "dshd-warnIcon", viewBox: "0 0 16 16", width: "11", height: "11", "aria-hidden": "true", focusable: "false", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M8 2.4 14.3 13.4H1.7z", fill: "currentColor" }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { x: "7.15", y: "6.2", width: "1.7", height: "3.4", rx: ".85", fill: "var(--dsw-alias-bg-base)" }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("circle", { cx: "8", cy: "11.3", r: "1", fill: "var(--dsw-alias-bg-base)" })
		  ] });
		}
		function StatCard(props) {
		  const { label, value, sub, hint, tone, spark } = props;
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-stat", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-statLabel", children: [
		      label,
		      hint !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Hint, { label: hint }) : null
		    ] }),
		    ...
		    spark !== void 0 && spark.values.length >= 2 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-statSpark", title: spark.title, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Sparkline, { values: spark.values, color: spark.color }) }) : null,
		    sub !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-statSub", title: sub, children: sub }) : null
		  ] });
		}
		function statusPill(status, t) {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-statusPill", "data-s": status, children: status === "running" ? t("stat.requests.running") : status === "error" ? t("stat.requests.error") : status === "compaction" ? t("stat.compactions") : t("stat.requests.completed") });
		}
		function RequestDetailPanel(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-detail", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-detailHead", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-detailTitle", children: [
		        t("trend.request"),
		        detail.seq
		      ] }),
		      detail.purpose === "compaction" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-tag", "data-k": "compaction", children: t("stat.compactions") }) : null,
		      detail.thinking ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-tag", "data-k": "reasoning", children: t("req.config.thinking") }) : null,
		      detail.retry > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-tag", "data-k": "error", title: detail.retryDelayMs === null ? void 0 : `${t("req.config.provider")} delay ${formatMs(detail.retryDelayMs)}`, children: [
		        t("req.retryCount"),
		        " ",
		        detail.retry,
		        "/",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-chip", children: [
		        t("req.turnStep"),
		        " ",
		        detail.turn,
		        "/",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-chip", children: detail.durationMs === null ? t("unknown") : formatMs(detail.durationMs) }),
		      startedLabel !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-chip", title: t("req.startedAt"), children: startedLabel }) : null,
		      onJump !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("button", { type: "button", className: "dshd-jumpText", onClick: onJump, children: [
		        t("req.jumpTrajectory"),
		        " \u2197"
		      ] }) : null
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kv", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.config.provider") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", title: detail.provider ?? void 0, children: detail.provider ?? t("unknown") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.model") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", title: detail.model ?? void 0, children: detail.model ?? t("unknown") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.config.temperature") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: detail.temperature === null ? t("unknown") : String(detail.temperature) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.config.maxTokens") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: detail.maxTokens === null ? t("unknown") : exactNumber(detail.maxTokens) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.config.effort") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: detail.reasoningEffort ?? t("unknown") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.prompt.systemChars") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: detail.promptSystemChars === null ? t("unknown") : exactNumber(detail.promptSystemChars) })
		      ] })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kv", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", title: t("hint.uncached"), children: t("req.usage.uncached") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: exactNumber(uncached) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.usage.cacheRead") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: exactNumber(detail.cacheReadTokens) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.usage.cacheWrite") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: exactNumber(detail.cacheWriteTokens) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.usage.output") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: exactNumber(detail.outputTokens) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", children: t("req.usage.reasoning") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: exactNumber(detail.reasoningTokens) })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvKey", title: t("hint.cost"), children: t("req.usage.cost") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: fmtCost(detail.costUsd) })
		      ] })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-kvKey", children: t("req.prompt.tools") }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-kvValue", style: { whiteSpace: "normal", wordBreak: "break-word" }, children: tools })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-kvKey", style: { marginBottom: "4px" }, children: t("req.toolCalls") }),
		      detail.toolCalls.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: "11.5px", padding: "2px 0" }, children: t("req.noToolCalls") }) : detail.toolCalls.map((call) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-toolRow", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-toolName", children: call.name }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-toolArgs", title: call.argsRaw ?? void 0, children: call.argsRaw ?? "" }),
		        call.isError ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-toolErr", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(WarnIcon, {}) }) : null,
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-toolDur", children: call.durationMs === null ? t("unknown") : formatMs(call.durationMs) })
		      ] }, call.callId))
		    ] }),
		    detail.error !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-kvKey", style: { marginBottom: "4px" }, children: t("req.error") }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-errorBox", children: detail.error })
		    ] }) : null
		  ] });
		}
		function TrendSection(props) {
		  const { metrics, t, actions, jumpTo } = props;
		  const [openSeq, setOpenSeq] = (0, import_react4.useState)(null);
		  ...
		  const [newArrived, setNewArrived] = (0, import_react4.useState)(false);
		  const lastSeqRef = (0, import_react4.useRef)(null);
		  ...
		  const renderRow = (s) => {
		    ...
		    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		      FragmentRow,
		      {
		        ...
		        cols: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            "span",
		            {
		              ...
		              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronIcon, { open })
		            }
		          ) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seq", children: s.seq }) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("td", { children: [
		            s.turn,
		            "/",
		            s.step
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-model", title: s.model ?? void 0, children: s.model ?? t("unknown") }) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: exactNumber(s.inputTokens) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: exactNumber(s.outputTokens) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: s.durationMs === null ? t("unknown") : formatMs(s.durationMs) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: s.purpose === "compaction" ? statusPill("compaction", t) : statusPill(s.status, t) }),
		          canJump ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            "button",
		            {
		              type: "button",
		              className: "dshd-jump",
		        ...
		        detail: open && detail !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          RequestDetailPanel,
		          {
		            detail,
		            t,
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.cacheRead, display: "inline-block" } }),
		          t("trend.cacheHit"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-seriesTotal", children: [
		            metrics.cacheHitPercent === null ? "\u2014" : `${metrics.cacheHitPercent}%`,
		            " ",
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-scopeTag", children: t("stat.scopeAll") })
		          ] })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          AreaChart,
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.input, display: "inline-block" } }),
		          t("trend.input"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", title: windowTitle, children: exactNumber(totalInput) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: tokenBars, height: 76, emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.output, display: "inline-block" } }),
		          t("trend.output"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", title: windowTitle, children: exactNumber(totalOutput) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: outputBars, height: 76, emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          ...
		          t("trend.duration"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", title: windowTitle, children: formatMs(windowDurationMs) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: durationBars, height: 76, valueFormatter: (v) => formatMs(v), emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.reasoning, display: "inline-block" } }),
		          t("trend.ttft"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", title: t("trend.ttftAvgNote"), children: windowTtftAvgMs === null ? "\u2014" : `${formatMs(windowTtftAvgMs)} ${t("timing.avg")}` })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          AreaChart,
		          {
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote,
		          metrics.ttftStats.p50 !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-ttftStats", children: [
		            "P50 ",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.input, display: "inline-block" } }),
		          t("trend.turnInput"),
		          lastTurnDelta !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		            "span",
		            {
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(AreaChart, { series: turnInputBars, height: 76, color: CHART_COLORS.input, valueFormatter: (v) => exactNumber(v), emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote,
		          compactionTurns.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-ttftStats", children: [
		            "\u25C6 ",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.cacheWrite, display: "inline-block" } }),
		          t("trend.cacheWrite"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", title: windowTitle, children: exactNumber(totalCacheWrite) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: cacheWriteBars, height: 76, emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.llm, display: "inline-block" } }),
		          t("trend.rateRequests")
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: rateReqBars, height: 60, emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-axisHint", children: t("trend.rateNote") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.input, display: "inline-block" } }),
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SeriesBars, { series: rateTokenBars, height: 60, emptyLabel: t("empty.requests"), showMaxTag: true, ariaLabel: t("aria.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-axisHint", children: t("trend.rateNote") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.output, display: "inline-block" } }),
		          t("trend.rateFailed"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-seriesTotal", children: exactNumber(totalFailed) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          AreaChart,
		          {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: { width: 9, height: 9, borderRadius: 2.5, background: CHART_COLORS.cacheWrite, display: "inline-block" } }),
		          t("trend.contextOcc"),
		          occNowPct !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-seriesTotal", children: [
		            occNowPct,
		            "%"
		          ] }) : null
		        ] }),
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-axisHint", children: t("hint.contextOccTrend") })
		      ] })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-viewTabs", role: "group", "aria-label": t("view.tabs.aria"), children: ["table", "turn", "model", "error"].map((v) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		      "button",
		      {
		        type: "button",
		        ...
		        children: [
		          t(`view.${v}`),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-badge", children: viewCounts[v] })
		        ]
		      },
		      v
		    )) }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-filters", role: "group", "aria-label": t("req.filter.aria"), children: [
		      ["all", "running", "complete", "error"].map((f) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		        "button",
		        {
		          type: "button",
		          ...
		          children: [
		            t(`req.filter.${f}`),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-badge", children: statusCounts[f] })
		          ]
		        },
		        f
		      )),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-spacer" }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		        "input",
		        {
		          type: "search",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dshd-filterBtn", title: t("req.exportHint"), onClick: exportJson, children: t("req.export") })
		    ] }),
		    view === "table" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-tableWrap", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", { className: "dshd-table", "aria-label": t("section.requests"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
		          ...
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: "#" }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("req.turnStep") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("req.model") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("trend.input") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("trend.output") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("trend.duration") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("req.status") }),
		          canJump ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", {}) : null
		        ] }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tbody", { children: [
		          rows.map(renderRow),
		          rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { colSpan: colCount, className: "dshd-tableEmpty", children: search.trim().length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
		            t("empty.search"),
		            " ",
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		              "button",
		          ...
		          ] }) : filter !== "all" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
		      ...
		      total > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-pager", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-pagerInfo", children: [
		          t("pager.page"),
		          " ",
		          safePage + 1,
		          t("pager.of"),
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-pagerBtns", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            "button",
		            {
		              type: "button",
		          ...
		          pageWindow.map(
		            (p, i) => p === "\u2026" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-pageEllipsis", children: "\u2026" }, `e${i}`) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		              "button",
		              {
		                type: "button",
		                className: "dshd-pageBtn",
		        ...
		        newArrived ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dshd-newBtn", onClick: () => {
		          setPage(0);
		          setNewArrived(false);
		        }, children: t("trend.newRequests") }) : null,
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("label", { className: "dshd-pageSize", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-muted", children: t("pager.perPage") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		            "select",
		            {
		              ...
		              children: [
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: 10, children: "10" }),
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: 20, children: "20" }),
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("option", { value: 50, children: "50" })
		              ]
		            }
		          )
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-groups", children: [
		        groups.map((g) => {
		          ...
		          return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-group", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		              "button",
		              {
		                type: "button",
		                ...
		                children: [
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-chevron", "data-open": isCollapsed ? void 0 : true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(ChevronIcon, { open: !isCollapsed }) }),
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-groupName", children: g.label }),
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-groupStats", children: [
		                    g.items.length,
		                    " ",
		                    t("pager.items"),
		                    " \xB7 ",
		            ...
		            !isCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-groupBody", children: [
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("table", { className: "dshd-table", "aria-label": g.label, children: [
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("tr", { children: [
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", {}),
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: "#" }),
		                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("th", { children: t("req.turnStep") }),
		                ...
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tbody", { children: g.items.slice(0, GROUP_ROW_CAP).map(renderRow) })
		              ] }),
		              g.items.length > GROUP_ROW_CAP ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-axisHint", children: t("group.tailNote").replace("{n}", String(GROUP_ROW_CAP)).replace("{m}", String(g.items.length - GROUP_ROW_CAP)) }) : null
		            ] }) : null
		          ] }, g.key);
		        }),
		        groups.length === 0 ? search.trim().length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-empty", style: { padding: "22px 0" }, children: [
		          t("empty.search"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dshd-clearFilter", onClick: () => setSearch(""), children: t("req.clearSearch") })
		        ] }) : filter !== "all" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-empty", style: { padding: "22px 0" }, children: [
		          t("empty.requestsFiltered"),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", className: "dshd-clearFilter", onClick: () => setFilter("all"), children: t("req.filter.all") })
		        ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", style: { padding: "22px 0" }, children: t("empty.requestsTable") }) : null
		      ] })
		    )
		  ] });
		}
		function FragmentRow(props) {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
		    ...
		    props.detail !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("td", { colSpan: props.colSpan, style: { padding: "0 8px 10px" }, children: props.detail }) }) : null
		  ] });
		}
		function DashboardView(props) {
		  const { useSession, useProjection, useSessions, t, actions, sessionId } = props;
		  const rootRef = (0, import_react4.useRef)(null);
		  const scrollHandlerRef = (0, import_react4.useRef)(null);
		  const restoringRef = (0, import_react4.useRef)(false);
		  const sessionRef = (0, import_react4.useRef)(sessionId);
		  sessionRef.current = sessionId;
		  const bindRoot = (0, import_react4.useCallback)((el) => {
		  ...
		  const [clock, setClock] = (0, import_react4.useState)(0);
		  (0, import_react4.useEffect)(() => {
		    if (!running) return;
		    const id = window.setInterval(() => setClock((c) => c + 1), 1e3);
		    return () => window.clearInterval(id);
		  ...
		  const board = useProjection("boardState");
		  const catalogs = useSessions((s) => s.subagentsByParent);
		  const subagents = childEntries(catalogs[sessionId]?.entries);
		  const hud = useHudData({ running, runningCalls, goal, todos, board, subagentEntries: subagents });
		  const metrics = (0, import_react4.useMemo)(
		    () => deriveMetrics(
		      {
		        running,
		  ...
		  if (!hasData) {
		    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { ref: bindRoot, className: "dshd-root", "data-conversation-composer-overlay": "", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HudStrip, { data: hud, t }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-header", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-title", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("view.dashboard") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-live", "data-off": running ? void 0 : true, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-liveDot" }),
		          running ? t("status.running") : t("status.idle")
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", children: t("empty") }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BoardBody, { ...props })
		    ] });
		  }
		  const tokenData = [
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { ref: bindRoot, className: "dshd-root", "data-conversation-composer-overlay": "", children: [
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-header", children: [
		      ...
		      model !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-chip", title: model, children: model }) : null,
		      metrics.modelSwitchCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-chip", title: t("hint.modelSwitches"), children: [
		        t("stat.modelSwitches"),
		        " \xD7",
		        metrics.modelSwitchCount
		      ] }) : null,
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-spacer" }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-muted", style: { fontSize: 11 }, children: windowNote })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-summary", role: "complementary", "aria-label": t("section.summary"), children: summary.map((s) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-summaryItem", title: s.label, children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-summaryLabel", children: s.label }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-summaryValue", children: s.value })
		    ] }, s.label)) }),
		    running ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-streamRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-streamDot" }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-streamText", children: [
		        t("status.streaming"),
		      ...
		      stuckRequests.map((x) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-streamWarn", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { role: "alert", children: t("status.stuckAlert").replace("{n}", String(x.seq)) }),
		        t("status.stuckTimer").replace("{s}", formatMs(x.elapsed))
		      ] }, `stuck${x.seq}`)),
		      runningCalls.map((c) => {
		        const elapsed = Math.max(0, nowMs - c.time);
		        return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: `dshd-streamTool${elapsed > stuckToolMs ? " dshd-streamWarn" : ""}`, children: [
		          t("status.tool"),
		          " ",
		          c.name,
		          " \xB7 ",
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-cardHead", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.overview") }) }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-stats", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.turns"), value: exactNumber(metrics.turns), hint: t("hint.turns") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.steps"), value: exactNumber(metrics.steps), hint: t("hint.steps") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          StatCard,
		          {
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.tools"), value: exactNumber(metrics.toolCallCount), hint: t("hint.tools"), sub: metrics.toolErrorCount > 0 ? `${metrics.toolErrorCount} ${t("stat.toolErrors")} (${Math.round(metrics.toolErrorCount / Math.max(1, metrics.toolCallCount) * 100)}%)` : void 0, tone: metrics.toolErrorCount > 0 ? "bad" : void 0 }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.compactions"), value: exactNumber(metrics.compactionRequests), hint: t("hint.compactions") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          StatCard,
		          {
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.modelSwitches"), value: exactNumber(metrics.modelSwitchCount), hint: t("hint.modelSwitches") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          StatCard,
		          {
		            label: t("stat.cost"),
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.tokens") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-cardHint", children: [
		          t("tokens.formula"),
		          " \xB7 ",
		          t("tokens.cacheNote")
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-stats", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.inputTokens"), value: exactNumber(metrics.inputTokens), hint: t("hint.inputTokens"), tone: "accent", spark: { values: sparkInput, color: CHART_COLORS.input, title: t("trend.newestRight") } }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.outputTokens"), value: exactNumber(metrics.outputTokens), hint: t("hint.outputTokens"), sub: metrics.reasoningTokens > 0 ? `${t("tokens.reasoning")} ${compactNumber(metrics.reasoningTokens)} (${t("role.windowNote")})` : void 0, spark: { values: sparkOutput, color: CHART_COLORS.output, title: t("trend.newestRight") } }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          StatCard,
		          {
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatCard, { label: t("stat.cacheHitRate"), value: metrics.cacheHitPercent === null ? t("unknown") : `${metrics.cacheHitPercent}${t("unit.percent")}`, hint: t("hint.cacheHitRate"), tone: metrics.cacheHitPercent !== null && metrics.cacheHitPercent >= 60 ? "good" : metrics.cacheHitPercent !== null && metrics.cacheHitPercent > 0 ? "accent" : void 0, sub: metrics.cacheHitPercent === null ? void 0 : `${t("stat.cacheRead")} ${compactNumber(metrics.cacheReadTokens)} / ${t("stat.inputTokens")} ${compactNumber(metrics.inputTokens)}`, spark: { values: sparkHit, color: CHART_COLORS.cacheRead, title: t("trend.newestRight") } })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StackedBar, { data: tokenData, valueFormatter: (v) => exactNumber(v), height: 20, totalLabel: t("total") })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-grid2", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("stat.contextOccupancy") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.contextOccupancy") })
		        ] }),
		        metrics.pressure?.projectedTokens === void 0 || metrics.pressure.contextWindow === void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", style: { padding: "22px 0" }, children: t("context.pressureMissing") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-gaugeRow", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-gaugeBox", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		              RadialGauge,
		              {
		            ...
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-gaugeLabel", children: [
		              exactNumber(metrics.pressure.projectedTokens),
		              " / ",
		              exactNumber(metrics.pressure.contextWindow)
		            ] })
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-col", style: { flex: 1, minWidth: 0 }, children: contextData.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", children: t("context.note") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StackedBar, { data: contextData, valueFormatter: (v) => exactNumber(v), height: 20, totalLabel: t("total") }) })
		        ] })
		      ] }),
		      metrics.contextInjection.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.contextInjection") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.contextInjection") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-col", children: metrics.contextInjection.map((c) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
		          "div",
		          {
		            className: "dshd-errRow",
		            title: `${c.role === "recall" ? t("contextRole.recall") : t("contextRole.inject")} \xB7 ${formLabel(c.form)}`,
		            children: [
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errMsg", children: [
		                c.label,
		                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-formBadge", "data-f": c.form, children: formLabel(c.form) })
		              ] }),
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		                "\xD7",
		                c.count,
		                " \xB7 ",
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.messages") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: windowNote })
		        ] }),
		        metrics.roles.total === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", children: t("unknown") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-donutRow", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DonutChart, { data: roleData, centerValue: String(metrics.roles.total), centerLabel: t("section.messages"), ariaLabel: t("aria.donut") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { flex: 1, minWidth: 0 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Legend, { data: roleData, percent: true }) })
		        ] })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.timing") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("stat.scopeAll") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          StackedBar,
		          {
		        ...
		        metrics.ttftByCache.hitN + metrics.ttftByCache.missN > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", children: t("section.ttftByCache") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kv", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-kvKey", style: { color: "var(--dsw-alias-state-success-primary)" }, children: [
		                t("ttftCache.hit"),
		                " (",
		                metrics.ttftByCache.hitN,
		                ")"
		              ] }),
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: metrics.ttftByCache.hitAvgMs === null ? t("unknown") : formatMs(metrics.ttftByCache.hitAvgMs) })
		            ] }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-kvItem", children: [
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-kvKey", style: { color: "var(--dsw-alias-state-warn-primary)" }, children: [
		                t("ttftCache.miss"),
		                " (",
		                metrics.ttftByCache.missN,
		                ")"
		              ] }),
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-kvValue", children: metrics.ttftByCache.missAvgMs === null ? t("unknown") : formatMs(metrics.ttftByCache.missAvgMs) })
		            ] })
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: 10.5 }, children: t("hint.ttftByCache") })
		        ] }) : metrics.assistantTtft.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: 10.5 }, children: t("hint.ttftByCacheMiss") }) : null,
		        metrics.durationStats.sampleCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", children: t("section.durationDist") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-percRow", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-perc", children: [
		              "P50 ",
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: formatMs(metrics.durationStats.p50 ?? 0) })
		            ] }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-perc", children: [
		              "P95 ",
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: formatMs(metrics.durationStats.p95 ?? 0) })
		            ] }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-perc", children: [
		              "P99 ",
		              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: formatMs(metrics.durationStats.p99 ?? 0) })
		            ] })
		          ] }),
		          (() => {
		            const maxCount = Math.max(1, ...metrics.durationStats.buckets.map((b) => b.count));
		            return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-hist", children: metrics.durationStats.buckets.map((b, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		              "div",
		              {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.turns") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.turnDurations") })
		        ] }),
		        metrics.turnDurations.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-empty", style: { padding: "18px 0" }, children: t("unknown") }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-turnList", children: metrics.turnDurations.map((td) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-turnRow", title: td.closed ? void 0 : t("hint.turnOpen"), children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-turnName", children: [
		            t("turns.label"),
		            td.turn,
		            td.closed ? "" : " ~"
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-turnTrack", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-turnFill", style: { width: `${td.durationMs / maxTurnMs * 100}%` } }) }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-turnValue", children: formatMs(td.durationMs) })
		        ] }, td.turn)) }),
		        turnTimings.size > metrics.turnDurations.length ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: 11, marginTop: 6 }, children: t("hint.turnTail") }) : null
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.tools") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("tools.note") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HorizontalBars, { data: toolRows, valueFormatter: (v) => exactNumber(v) }),
		        metrics.toolHistogram.length > 8 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: 11 }, children: t("req.toolTail").replace("{n}", String(metrics.toolHistogram.length - 8)) }) : null,
		        metrics.toolDurationTop.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", children: t("tools.durationTop") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            HorizontalBars,
		            {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.models") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.modelTimeline") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HorizontalBars, { data: modelRows, valueFormatter: (v) => exactNumber(v), subBelow: true }),
		        metrics.modelSplit.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { marginTop: 8 }, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            StackedBar,
		            {
		          ...
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-muted", style: { fontSize: 10.5 }, children: t("hint.modelCost") })
		        ] }) : null,
		        metrics.modelTimeline.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { marginTop: 10 }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		          ModelTimeline,
		          {
		      ...
		      errorRows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-cardHead", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.errors") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HorizontalBars, { data: errorRows, valueFormatter: (v) => exactNumber(v) }),
		        metrics.commandRows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", children: t("section.commands") }),
		          metrics.commandRows.map((c) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-errRow", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-errMsg", children: c.name }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		              "\xD7",
		              c.count
		            ] })
		        ...
		        metrics.retriedRequests > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-subTitle", style: { marginTop: 8 }, children: [
		          t("stat.retryWait"),
		          " ",
		        ...
		        metrics.failedStats.count > 0 && metrics.completedStats.count > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", style: { marginTop: 8 }, children: t("hint.failedProfile").replace("{a}", metrics.failedStats.avgDurationMs === null ? "\u2014" : formatMs(metrics.failedStats.avgDurationMs)).replace("{b}", metrics.completedStats.avgDurationMs === null ? "\u2014" : formatMs(metrics.completedStats.avgDurationMs)) }) : null
		      ] }) : null,
		      metrics.topErrors.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-cardHead", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.errorTop") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-col", children: metrics.topErrors.map((e) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-errRow", title: e.message, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-errMsg", children: e.message }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		            "\xD7",
		            e.count
		          ] })
		      ...
		      metrics.compactionEffect.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.compaction") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.compactionEffect") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-col", children: metrics.compactionEffect.map((e) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-compactRow", title: `${t("req.seq")} ${e.seq}`, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-compactSeq", children: [
		            t("turns.label"),
		            e.turn
		          ] }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-compactArrow", children: [
		            e.beforeTokens === null ? t("unknown") : exactNumber(e.beforeTokens),
		            " \u2192 ",
		            e.afterTokens === null ? t("unknown") : exactNumber(e.afterTokens)
		          ] }),
		          e.recoveredTokens !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-compactRecovered", children: [
		            "\u2212",
		      ...
		      metrics.effortStats.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-cardHead", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.effort") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-col", children: metrics.effortStats.map((e) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-errRow", title: t("hint.effort"), children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-errMsg", children: e.effort }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		      ...
		      metrics.loops.length > 0 || metrics.noProgress.length > 0 || metrics.toolStorm.some((b) => b.calls > 0) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.health") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: t("hint.health") })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-col", children: [
		          metrics.loops.map((l) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-errRow", title: `${t("hint.loop")} ${l.seqs.join(", ")}`, children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-healthTag", "data-k": "loop", children: t("health.loop") }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-errMsg", children: l.name }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		              "\xD7",
		              l.count
		            ] })
		          ] }, `${l.name}${l.count}`)),
		          metrics.noProgress.map((p) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-errRow", title: `${t("req.seq")} ${p.seq}`, children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-healthTag", "data-k": "noProgress", children: t("health.noProgress") }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-errMsg", children: t("hint.noProgress") }),
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-errCount", children: [
		              t("turns.label"),
		              p.turn,
		              " \xB7 ",
		        ...
		        metrics.toolStorm.some((b) => b.calls > 0) ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { marginTop: 8 }, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-subTitle", children: t("trend.toolStorm") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
		            SeriesBars,
		            {
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { className: "dshd-card", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-cardHead", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardTitle", children: t("section.trend") }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-cardHint", children: actions !== void 0 ? t("req.rowHint.jump") : t("req.rowHint.expand") })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TrendSection, { metrics, t, actions, jumpTo })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BoardBody, { ...props })
		  ] });
		}
