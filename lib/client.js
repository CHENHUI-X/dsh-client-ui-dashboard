window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "stream.liveOutput": "\u6B63\u5728\u751F\u6210\u5185\u5BB9",
		  "stream.think": "\u601D\u7EF4\u8FC7\u7A0B",
		  "stream.output": "\u6587\u672C\u8F93\u51FA",
		  "stream.detail": "\u8FC7\u7A0B\u6570\u636E",
		  "stream.reasoningOutput": "\u6B63\u5728\u751F\u6210\u601D\u7EF4\u8FC7\u7A0B",
		  "stream.onlyReasoning": "\u5F53\u524D\u9636\u6BB5\u4E3A\u601D\u7EF4\u8FC7\u7A0B\uFF0C\u6587\u672C\u8F93\u51FA\u5C1A\u672A\u5F00\u59CB",
		  "stream.fallback": "\u5F53\u524D\u6D41\u5C1A\u672A\u4EA7\u51FA\u53EF\u89C1\u6587\u672C",
		  "status.tool": "\u5DE5\u5177",
		...
		var en = {
		  ...
		  "stream.liveOutput": "Streaming output",
		  "stream.think": "Think",
		  "stream.output": "Output",
		  "stream.detail": "Process data",
		  "stream.reasoningOutput": "Streaming reasoning",
		  "stream.onlyReasoning": "Reasoning stage; text output not started yet",
		  "stream.fallback": "No visible text in current stream",
		  "status.tool": "tool",
		...
		function Chip(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dshd-hud-chip", "data-tone": tone, children: [
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dshd-hud-value", children: [
		      value,
		      quietSuffix !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { "aria-hidden": "true", children: quietSuffix })
		    ] })
		  ] });
		}
		function HudStrip(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dshd-hud", role: "status", children: [
		    ...
		    data.currentTool !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        ...
		        quietSuffix: ` \xB7 ${elapsedLabel(data.currentTool.time, nowMs)}`
		      }
		    ),
		    ...
		    data.nextSchedule !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		      Chip,
		      {
		        ...
		        value: data.nextScheduleOverdue ? t("board.schedule.overdue") : scheduleDueLabel(data.nextSchedule)
		      }
		    )
		  ] });
		}
		...
		var ARCHIVE_AFTER_MS = 5 * 60 * 1e3;
		var ARCHIVE_CLOCK_MS = 15e3;
		function summaryOf(summaries, childId) {
		  const value = summaries[childId];
		  if (typeof value !== "object" || value === null) return void 0;
		  return value;
		}
		function subagentState(entry, summary) {
		...
		function estimatedEndAt(summary) {
		  ...
		  if (through !== void 0) return through;
		  if (updatedAt === void 0) return void 0;
		  const settledMs = finiteTime(timing?.settledMs);
		  return settledMs === void 0 ? updatedAt : updatedAt + settledMs;
		}
		function SubagentCard(props) {
		  ...
		  const status = state === "running" ? t("board.subagents.running") : state === "completed" ? t("board.subagents.completed") : t("board.subagents.inactive");
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("article", { className: "dshd-subagentCard", "data-state": state, title: entry.id, children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-subagentCardHead", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-subagentDot", "aria-hidden": "true" }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-subagentIdentity", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-subagentTitle", children: label }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-subagentMode", children: mode })
		      ] }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-subagentStatus", children: status })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-subagentMeta", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: entry.id }),
		      state === "inactive" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-subagentMetaHint", children: t("board.subagents.inactiveNote") }),
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		        "button",
		        {
		          ...
		          children: t("board.subagents.open")
		        }
		      )
		    ] })
		  ] });
		...
		function BoardBody(props) {
		  ...
		  const [archiveOpen, setArchiveOpen] = (0, import_react2.useState)(false);
		  ...
		  const rows = subagents.map((entry) => {
		    ...
		    const state = subagentState(entry, summary);
		    const endedAt = state === "running" ? void 0 : estimatedEndAt(summary);
		    const archived = endedAt !== void 0 && now - endedAt >= ARCHIVE_AFTER_MS;
		    return { entry, summary, state, endedAt, archived };
		  });
		  const stateRank = { running: 0, completed: 1, inactive: 2 };
		  const visibleRows = rows.filter((row) => !row.archived).sort((a, b) => stateRank[a.state] - stateRank[b.state]);
		  const archivedRows = rows.filter((row) => row.archived).sort((a, b) => (b.endedAt ?? 0) - (a.endedAt ?? 0));
		  ...
		  const card = (row) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		    SubagentCard,
		    {
		      entry: row.entry,
		      summary: row.summary,
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		    ...
		    subagents.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-subagentEmpty", children: t("board.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-subagentStatusBar", "aria-label": t("board.section"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dshd-subagentStatusStat", "data-state": "running", "data-populated": runningCount > 0 ? "true" : void 0, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.running") }),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: runningCount })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dshd-subagentStatusStat", "data-state": "completed", "data-populated": completedCount > 0 ? "true" : void 0, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.completed") }),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: completedCount })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dshd-subagentStatusStat", "data-state": "inactive", "data-populated": inactiveCount > 0 ? "true" : void 0, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.inactive") }),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: inactiveCount })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
		          "button",
		          {
		            ...
		            "data-state": "archived",
		            "data-populated": archiveCount > 0 ? "true" : void 0,
		            "aria-expanded": archiveOpen,
		            "aria-controls": archivePanelId,
		            "aria-label": t("board.subagents.archiveAria").replace("{action}", archiveOpen ? t("board.subagents.collapse") : t("board.subagents.expand")).replace("{n}", String(archiveCount)),
		            disabled: archiveCount === 0,
		            onClick: () => setArchiveOpen((open) => !open),
		            children: [
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.archived") }),
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "dshd-subagentArchiveMeta", children: [
		                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { children: archiveCount }),
		                archiveOpen ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives.IconChevronDownOutline14, {}) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives.IconChevronRightOutline14, {})
		              ] })
		            ]
		          }
		        )
		      ] }),
		      runningCount === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-subagentRunningEmpty", children: t("board.subagents.runningEmpty") }) : null,
		      visibleRows.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-subagentPanel", "aria-label": t("board.subagents.listTitle"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentPanelHead", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: t("board.subagents.listTitle") }),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.count").replace("{n}", String(visibleRows.length)) })
		        ] }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentGrid", children: visibleRows.map(card) })
		      ] }) : null,
		      archiveOpen && archiveCount > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
		        "section",
		        {
		          id: archivePanelId,
		          ...
		          children: [
		            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentPanelHead", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { children: t("board.subagents.archived") }),
		              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.count").replace("{n}", String(archiveCount)) })
		            ] }) }),
		            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentGrid", children: archivedRows.map(card) })
		          ]
		        }
		      ) : null
		    ] }),
		...
		var STREAM_MAX_CHARS = 100;
		function gatherStreamFragments(input, out) {
		  ...
		  if (Array.isArray(input)) {
		    for (const item2 of input) gatherStreamFragments(item2, out);
		    return;
		  }
		  const item = input;
		  if (typeof item.text === "string") {
		    const value = item.text;
		    const kind2 = item.kind ?? item.type;
		    if (kind2 === "reasoning") {
		      out.push({ kind: "reasoning", text: value });
		    } else if (kind2 === "tool-call") {
		      out.push({ kind: "tool-call", text: value, name: typeof item.name === "string" ? item.name : void 0 });
		    } else {
		  ...
		  if (kind === "other" && item.block !== void 0) {
		    let detail;
		    ...
		    if (detail !== void 0) out.push({ kind: "other", text: detail });
		    return;
		  }
		...
		function compactStreamLine(input, maxChars) {
		...
		function currentStreamingItem(stream) {
		  for (let i = stream.length - 1; i >= 0; i -= 1) {
		    const item = stream[i];
		    if (item !== void 0 && (item.kind === "tool-call" || item.text.trim().length > 0)) return item;
		  }
		  return stream.at(-1) ?? null;
		}
		function extractStreamingBlocks(partial) {
		  const blocks = (() => {
		    if (partial === null || typeof partial !== "object") return [];
		    if (Array.isArray(partial.blocks)) return partial.blocks;
		    return [partial];
		  })();
		  const stream = [];
		...
		function summarizeStreamChars(stream) {
		  let text = 0;
		  let reasoning = 0;
		...
		function Hint(props) {
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives2.Tooltip, { label: props.label, side: "top", delayMs: 450, maxWidth: 260, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-hint", role: "button", tabIndex: 0, "aria-label": props.label, children: "?" }) });
		}
		function fmtCost(v) {
		  if (v <= 0) return "$0";
		...
		function DashboardView(props) {
		  ...
		  const streamingBlocks = (0, import_react4.useMemo)(() => extractStreamingBlocks(partial), [partial]);
		  const streamed = (0, import_react4.useMemo)(() => summarizeStreamChars(streamingBlocks), [streamingBlocks]);
		  const liveItem = (0, import_react4.useMemo)(() => currentStreamingItem(streamingBlocks), [streamingBlocks]);
		  const livePreview = (0, import_react4.useMemo)(
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { ref: bindRoot, className: "dshd-root", "data-conversation-composer-overlay": "", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-dashboardHead", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-header", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "dshd-title", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { children: t("view.dashboard") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-live", "data-off": running ? void 0 : true, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-liveDot" }),
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(HudStrip, { data: hud, t }),
		    running ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-streamRow", role: "status", "aria-live": "polite", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-streamDot" }),
		      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-streamBody", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-streamHead", children: [
		          ...
		          stuckRequests[0] !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: "dshd-streamWarn", children: [
		            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { role: "alert", children: t("status.stuckAlert").replace("{n}", String(stuckRequests[0].seq)) }),
		            t("status.stuckTimer").replace("{s}", formatMs(stuckRequests[0].elapsed))
		          ] }) : null,
		          runningCalls.at(-1) !== void 0 ? (() => {
		            ...
		            return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("span", { className: `dshd-streamTool${elapsed > stuckToolMs ? " dshd-streamWarn" : ""}`, children: [
		              ...
		              " \xB7 ",
		              formatMs(elapsed),
		              runningCalls.length > 1 ? ` +${runningCalls.length - 1}` : ""
		            ] });
		          })() : null
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "dshd-streamLine", "data-kind": liveItem?.kind ?? "empty", "aria-label": t("stream.liveOutput"), title: liveItem?.text || void 0, children: [
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-streamMarker", "aria-hidden": "true", children: liveItem?.kind === "reasoning" ? "Think" : liveItem?.kind === "text" ? "Output" : liveItem?.kind === "tool-call" ? "Tool" : "Live" }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-streamSegmentLabel", children: liveItem?.kind === "reasoning" ? t("stream.think") : liveItem?.kind === "text" ? t("stream.output") : liveItem?.kind === "tool-call" ? liveItem.name || t("status.tool") : t("stream.liveOutput") }),
		          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "dshd-streamLineText", children: livePreview || (liveItem?.kind === "reasoning" ? t("stream.onlyReasoning") : t("stream.fallback")) })
		        ] })
		      ] })
		    ] }) : null,
