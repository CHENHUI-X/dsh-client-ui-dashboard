window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function BoardBody(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		    ...
		    subagents.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dshd-subagentEmpty", children: t("board.empty") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-subagentPanel", "aria-label": t("board.subagents.listTitle"), children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentPanelHead", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
		          ...
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("board.subagents.count").replace("{n}", String(subagents.length)) })
		        ] }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-subagentGrid", children: orderedRows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          SubagentCard,
		          {
		            entry: row.entry,
		            summary: row.summary,
		...
		function TrendSection(props) {
		  ...
		  const [openSeq, setOpenSeq] = (0, import_react3.useState)(null);
		  ...
		  const [newArrived, setNewArrived] = (0, import_react3.useState)(false);
		  const lastSeqRef = (0, import_react3.useRef)(null);
		  ...
		  const [view, setView] = (0, import_react3.useState)("table");
		...
		function DashboardView(props) {
		  ...
		  const scrollHandlerRef = (0, import_react3.useRef)(null);
		  const restoringRef = (0, import_react3.useRef)(false);
		  const sessionRef = (0, import_react3.useRef)(sessionId);
		  sessionRef.current = sessionId;
		  const bindRoot = (0, import_react3.useCallback)((el) => {
		  ...
		  const [clock, setClock] = (0, import_react3.useState)(0);
		  (0, import_react3.useEffect)(() => {
		    if (!running) return;
		  ...
		  const metrics = (0, import_react3.useMemo)(
		    () => deriveMetrics(
		      {
		        running,
		  ...
		  const streamingBlocks = (0, import_react3.useMemo)(() => extractStreamingBlocks(partial), [partial]);
		  const streamed = (0, import_react3.useMemo)(() => summarizeStreamChars(streamingBlocks), [streamingBlocks]);
		  const liveItem = (0, import_react3.useMemo)(() => currentStreamingItem(streamingBlocks), [streamingBlocks]);
		  const livePreview = (0, import_react3.useMemo)(
