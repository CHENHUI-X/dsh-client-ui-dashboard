window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
		  ...
		  "hint.cacheHitRate": "\u7F13\u5B58\u547D\u4E2D tokens \xF7 \u8BA1\u8D39\u8F93\u5165 tokens\u3002\u547D\u4E2D\u7387\u8D8A\u9AD8,\u8F93\u5165\u6210\u672C\u8D8A\u4F4E\u3002",
		  ...
		  "hint.decodeSpeed": "\u89E3\u7801\u541E\u5410 = \u89E3\u7801 tokens \xF7 \u89E3\u7801\u8017\u65F6\u3002",
		  ...
		  "hint.cost": "\u6309 DeepSeek \u516C\u5F00\u5B9A\u4EF7(\u6BCF 1M tokens:chat \u672A\u547D\u4E2D $0.27 / \u547D\u4E2D $0.07 / \u8F93\u51FA $1.10;reasoner \u7FFB\u500D)\u7C97\u4F30\u7684\u7F8E\u5143\u6210\u672C;\u7F13\u5B58\u8282\u7701 = \u547D\u4E2D tokens \u6309\u672A\u547D\u4E2D\u4EF7\u6298\u7B97\u3002",
		  ...
		  "hint.modelTimeline": "\u6BCF\u4E2A\u8BF7\u6C42\u4E00\u4E2A\u70B9,\u6309\u6A21\u578B\u7740\u8272;\u5E26\u7425\u73C0\u73AF = \u6A21\u578B\u5207\u6362,\u70B9\u51FB\u8DF3\u8F6C",
		  ...
		  "req.export": "\u5BFC\u51FA JSON",
		  "req.exportHint": "\u5BFC\u51FA\u5F53\u524D\u7B5B\u9009\u4E0B\u7684\u8BF7\u6C42\u660E\u7EC6(JSON)",
		...
		var en = {
		  ...
		  "hint.cacheHitRate": "Cache-hit tokens \xF7 billed input tokens. Higher = cheaper input.",
		  ...
		  "hint.decodeSpeed": "Decode throughput = decode tokens \xF7 decode time.",
		  ...
		  "hint.cost": "Rough USD cost at DeepSeek public pricing (per 1M tokens: chat miss $0.27 / hit $0.07 / output $1.10; reasoner doubles it). Cache savings = read tokens billed at the miss rate.",
		  ...
		  "hint.modelTimeline": "One dot per request, colored by model; amber ring = model switch. Click to jump.",
		  ...
		  "req.exportHint": "Export the requests under the current filter as JSON",
		...
		function deriveMetrics(input) {
		  ...
		  const noProgress = details.filter((d) => d.status === "complete" && d.outputTokens < 50 && d.toolCalls.length >= 3).map((d) => ({ seq: d.seq, turn: d.turn, outputTokens: d.outputTokens, toolCalls: d.toolCalls.length }));
		  const loops = detectLoops(details);
		  const modelTimeline = [...series].reverse().map((s) => ({ seq: s.seq, turn: s.turn, model: s.model ?? "?" }));
		  const modelSwitchSeqs = modelTimeline.filter((m, i) => i > 0 && m.model !== modelTimeline[i - 1].model).map((m) => m.seq);
		  ...
		  if (tokenUsage !== void 0) {
		    ...
		    costTotal = ((uncached + cacheWrite) * miss + cacheRead * hitPrice + output * out) / 1e6;
		    costSavings = cacheRead * miss / 1e6;
		  }
		...
		.dshd-live{display:inline-flex;align-items:center;gap:6px;font-size:11px;font-weight:500;color:var(--dsw-alias-state-success-primary);border:1px solid color-mix(in srgb,var(--dsw-alias-state-success-primary) 35%,transparent);border-radius:999px;padding:2px 8px;white-space:nowrap}
		...
		.dshd-cardHint{font-size:11px;color:var(--dsw-alias-label-tertiary)}
		...
		.dshd-statValue{font-size:clamp(15px,1.2rem + .5vw,20px);font-weight:650;line-height:1.2;font-variant-numeric:tabular-nums;font-family:var(--ds-font-family-code,ui-monospace,SFMono-Regular,Menlo,monospace)}
		...
		.dshd-legendRow{display:inline-flex;align-items:center;gap:6px;font-size:11.5px;color:var(--dsw-alias-label-secondary);white-space:nowrap}
		.dshd-legendSwatch{width:9px;height:9px;border-radius:2.5px;flex:none}
		.dshd-legendName{overflow:hidden;text-overflow:ellipsis}
		...
		.dshd-hbar{display:flex;align-items:center;gap:8px;font-size:11.5px;min-width:0}
		...
		.dshd-table th{text-align:left;font-size:10.5px;font-weight:600;color:var(--dsw-alias-label-tertiary);text-transform:uppercase;letter-spacing:.04em;padding:2px 8px 6px;border-bottom:1px solid var(--dsw-alias-border-l2);white-space:nowrap;position:sticky;top:0;background:var(--dsw-alias-bg-layer-1);z-index:2}
		...
		.dshd-tag{font-size:10px;border-radius:5px;padding:1px 6px;border:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-secondary);font-weight:600;white-space:nowrap}
		...
		.dshd-axisHint{font-size:10px;color:var(--dsw-alias-label-tertiary);text-align:right;font-variant-numeric:tabular-nums;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
		...
		.dshd-groupName{font-weight:650}
		...
		.dshd-modelNote{font-size:10px;color:var(--dsw-alias-label-tertiary);padding:2px 2px 0}
		...
		.dshd-streamDot{width:7px;height:7px;border-radius:50%;background:var(--dsw-alias-state-success-primary);animation:dshdPulse 1.4s ease-in-out infinite;flex:none}
		...
		.dshd-ttftStats{display:block;margin-top:2px;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}
		...
		.dshd-hist{display:flex;align-items:flex-end;gap:3px;height:52px}
		.dshd-histCol{flex:1;height:100%;display:flex;align-items:flex-end;min-width:0}
		.dshd-histBar{width:100%;border-radius:2px 2px 0 0;min-height:2px;transition:height .25s ease}
		...
		.dshd-turnName{width:56px;flex:none;color:var(--dsw-alias-label-secondary);font-variant-numeric:tabular-nums}
		...
		.dshd-cardHint{overflow-wrap:anywhere;min-width:0}
		...
		.dshd-vtip{position:absolute;left:50%;transform:translateX(-50%);background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);border-radius:8px;padding:4px 9px;font-size:11px;line-height:1.4;color:var(--dsw-alias-label-primary);white-space:normal;overflow-wrap:anywhere;text-align:center;width:max-content;max-width:min(240px,80vw);z-index:20;pointer-events:none;box-shadow:var(--dsw-alias-shadow,0 4px 12px rgb(0 0 0 / .22));font-variant-numeric:tabular-nums;box-sizing:border-box}
		...
		.dshd-areaWrap .dshd-vtip{transform:translate(-50%,calc(-100% - 6px))}
		...
		.dshd-gaugeLabel{font-size:10px;color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}

		/* Jump affordance */
		.dshd-jump{font-size:10.5px;font-weight:600;color:var(--dsw-alias-state-business-primary);border:1px solid color-mix(in srgb,var(--dsw-alias-state-business-primary) 35%,transparent);background:color-mix(in srgb,var(--dsw-alias-state-business-primary) 8%,transparent);border-radius:999px;padding:1px 9px;cursor:pointer;transition:background .15s;white-space:nowrap}
		.dshd-jump:hover{background:color-mix(in srgb,var(--dsw-alias-state-business-primary) 16%,transparent)}
		...
		function DonutChart(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: `0 0 ${size} ${size}`, width: size, height: size, role: "img", children: [
		...
		function SeriesBars(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dshd-vbars", style: { height }, children: series.map((s, i) => {
		...
		function HorizontalBars(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dshd-hbars", children: data.map((d) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dshd-hbar", title: d.title ?? `${d.label}: ${fmt(d.value)}`, children: [
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dshd-hbarRight", children: [
		      ...
		      d.sub !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dshd-hbarSub", children: d.sub }) : null
		    ] })
		  ] }, d.label)) });
		}
		function AreaChart(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
		    "div",
		    {
		      ...
		      onMouseLeave: () => setHover(null),
		      children: [
		        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, preserveAspectRatio: "none", role: "img", children: [
		...
		function RadialGauge(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { viewBox: `0 0 ${size} ${height}`, width: size, height, role: "img", style: { overflow: "hidden" }, children: [
		...
		function ModelTimeline({
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dshd-modelTimeline", role: "img", "aria-label": "model timeline", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, style: { display: "block" }, children: trimmed.map((d, i) => {
		      ...
		      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
		        "circle",
		        {
		          ...
		          tabIndex: onPick !== void 0 ? 0 : void 0,
		          ...
		          style: { cursor: onPick !== void 0 ? "pointer" : void 0, outline: "none" },
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dshd-modelLegend", children: models.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dshd-modelLegendItem", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { style: { background: modelColorHash(m) } }),
		      m
		    ] }, m)) })
		  ] });
		}
		...
		function Hint(props) {
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives.Tooltip, { label: props.label, side: "top", delayMs: 450, maxWidth: 260, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-hint", tabIndex: 0, children: "?" }) });
		}
		function StatCard(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-stat", children: [
		    ...
		    sub !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-statSub", children: sub }) : null
		  ] });
		}
		...
		function RequestDetailPanel(props) {
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-detail", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-detailHead", children: [
		      ...
		      onJump !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { type: "button", className: "dshd-jump", onClick: onJump, children: [
		...
		function TrendSection(props) {
		  ...
		  const prevLen = (0, import_react2.useRef)(0);
		  ...
		  const exportJson = () => {
		    ...
		    a.href = url;
		    a.download = `dashboard-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 19).replace(/[:T]/g, "-")}.json`;
		    a.click();
		  ...
		  const groups = (() => {
		    ...
		    for (const s of searched) {
		      ...
		      else key = s.status === "error" ? s.error ?? t("unknown") : t("stat.requests.ok");
		  ...
		  const durationBars = display.map((s) => ({
		    label: `${t("trend.request")}${s.seq}`,
		  ...
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-col", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          ...
		          t("trend.cacheHit"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-seriesTotal", children: metrics.cacheHitPercent === null ? "\u2014" : `${metrics.cacheHitPercent}%` })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          AreaChart,
		          {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: tokenBars, height: 76, emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: outputBars, height: 76, emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          ...
		          t("trend.duration"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-seriesTotal", title: windowTitle, children: formatMs(metrics.totalDurationMs) })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: durationBars, height: 76, valueFormatter: (v) => formatMs(v), emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesLabel", children: [
		          ...
		          t("trend.ttft"),
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-seriesTotal", title: t("trend.ttftAvgNote"), children: metrics.avgTtftMs === null ? "\u2014" : `${formatMs(metrics.avgTtftMs)} ${t("timing.avg")}` })
		        ] }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          AreaChart,
		          {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AreaChart, { series: turnInputBars, height: 76, color: CHART_COLORS.input, valueFormatter: (v) => exactNumber(v), emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote,
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: cacheWriteBars, height: 76, emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-axisHint", children: [
		          t("trend.newestRight"),
		          scopeNote
		        ] })
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesRow", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: rateReqBars, height: 60, emptyLabel: t("empty.requests") }),
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-seriesCol", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SeriesBars, { series: rateTokenBars, height: 60, emptyLabel: t("empty.requests") }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-axisHint", children: t("trend.rateNote") })
		      ] })
		    ] }),
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-viewTabs", role: "tablist", "aria-label": t("section.summary"), children: ["table", "turn", "model", "error"].map((v) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		      "button",
		      {
		        type: "button",
		        role: "tab",
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-filters", role: "group", "aria-label": canJump ? t("req.rowHint.jump") : t("req.rowHint.expand"), children: [
		      ["all", "running", "complete", "error"].map((f) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		        "button",
		        {
		          type: "button",
		    ...
		    view === "table" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-tableWrap", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("table", { className: "dshd-table", "aria-label": canJump ? t("req.rowHint.jump") : t("req.rowHint.expand"), children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("tbody", { children: [
		          rows.map(renderRow),
		          rows.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("tr", { children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("td", { colSpan: colCount, className: "dshd-tableEmpty", children: filter !== "all" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-groups", children: [
		        groups.map((g) => {
		          ...
		          return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-group", children: [
		            ...
		            !isCollapsed ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-groupBody", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("table", { className: "dshd-table", "aria-label": g.label, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("tbody", { children: g.items.map(renderRow) }) }) }) : null
		          ] }, g.key);
		        }),
		        groups.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-empty", style: { padding: "22px 0" }, children: search.trim().length > 0 ? t("empty.search") : t("empty.requestsTable") }) : null
		      ] })
		    )
		  ] });
		}
		...
		function DashboardView(props) {
		  ...
		  if (!hasData) {
		    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-root", children: [
		  ...
		  const modelRows = metrics.modelSplit.map((m, i) => ({
		    ...
		    sub: `${m.requests} ${t("models.requests")} \xB7 ${compactNumber(m.inputTokens)}\u2192${compactNumber(m.outputTokens)}${m.avgDurationMs !== null ? ` \xB7 ${formatMs(m.avgDurationMs)}` : ""}${m.errorCount > 0 ? ` \xB7 ${m.errorCount}\u26A0` : ""}`
		  }));
		  const errorRows = [
		  ...
		  if (metrics.costEstimateUsd.total > 0) {
		    summary.push({ label: t("stat.cost"), value: `$${metrics.costEstimateUsd.total.toFixed(4)}` });
		  }
		  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-root", children: [
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-header", children: [
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-title", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: t("view.dashboard") }) }),
		      ...
		      model !== null ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-chip", children: model }) : null,
		    ...
		    running ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-streamRow", role: "status", children: [
		      ...
		      stuckRequests.map((x) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-streamWarn", role: "alert", children: t("status.stuck").replace("{n}", String(x.seq)).replace("{s}", formatMs(x.elapsed)) }, `stuck${x.seq}`)),
		      runningCalls.map((c) => {
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-stats", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		          {
		            ...
		            sub: metrics.compactionRequests > 0 ? `${exactNumber(metrics.compactionRequests)} ${t("stat.compactions")}${metrics.compactionRecoveredItems === null ? "" : ` \xB7 ${exactNumber(metrics.compactionRecoveredItems)} ${t("stat.compactionItems")}`}` : void 0
		          }
		        ),
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		          {
		            ...
		            hint: t("hint.cost"),
		            sub: metrics.costEstimateUsd.cacheSavings > 0 ? `${t("stat.costSavings")} $${metrics.costEstimateUsd.cacheSavings.toFixed(4)}` : void 0
		          }
		        ),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		          {
		            ...
		            hint: t("hint.avgTtft"),
		            sub: metrics.ttftSteps > 0 ? `${metrics.ttftSteps} ${t("timing.ttft")}` : void 0
		          }
		        ),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-stats", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StatCard,
		          {
		            ...
		            sub: metrics.outputTokens > 0 ? `${t("stat.reasoningShare")} ${Math.round(metrics.reasoningTokens / metrics.outputTokens * 100)}%` : void 0,
		            tone: metrics.reasoningTokens > 0 ? "accent" : void 0
		          }
		        ),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(StatCard, { label: t("stat.cacheHitRate"), value: metrics.cacheHitPercent === null ? t("unknown") : `${metrics.cacheHitPercent}${t("unit.percent")}`, hint: t("hint.cacheHitRate"), tone: metrics.cacheHitPercent !== null && metrics.cacheHitPercent >= 60 ? "good" : metrics.cacheHitPercent !== null && metrics.cacheHitPercent > 0 ? "accent" : void 0, sub: metrics.cacheHitPercent === null ? void 0 : `${t("stat.cacheRead")} ${exactNumber(metrics.cacheReadTokens)} / ${t("stat.inputTokens")} ${exactNumber(metrics.inputTokens)}`, spark: { values: sparkHit, color: CHART_COLORS.cacheRead, title: t("trend.newestRight") } })
		      ] }),
		    ...
		    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-grid2", children: [
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-card", children: [
		        ...
		        metrics.roles.total === 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-empty", children: t("unknown") }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dshd-donutRow", children: [
		          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DonutChart, { data: roleData, centerValue: String(metrics.roles.total), centerLabel: t("section.messages") }),
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-card", children: [
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dshd-cardHead", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dshd-cardTitle", children: t("section.timing") }) }),
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
		          StackedBar,
		          {
		            data: [
		      ...
		      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "dshd-card", children: [
		        ...
		        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(HorizontalBars, { data: modelRows, valueFormatter: (v) => exactNumber(v) }),
